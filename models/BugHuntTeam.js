...
const schema=new mongoose.Schema({
 ...
 teamName:{type:String,required:true,trim:true},members:{type:[String],default:[]},passwordHash:{type:String,required:true},
 ...
 wrongSubmissions:{type:Number,default:0},rank:{type:Number,default:null},finalPlace:{type:Number,default:null},
