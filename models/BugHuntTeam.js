...
const bugHuntTeamSchema = new mongoose.Schema({
    ...
    currentRound: {
        type: String,
        enum: ["waiting_start", "round1", "round2", "round3", "surprise", "awaiting_ranking", "final", "eliminated", "completed"],
...
module.exports = mongoose.model("BugHuntTeam", bugHuntTeamSchema);
